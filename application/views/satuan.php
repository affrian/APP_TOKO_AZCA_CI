	...
	<div class="kategori">
		...
		<form id="frm_satuan">
		  <div class="form-group row">
		    ...
		    <div class="col-sm-9">
		      <input type="text" class="form-control" id="stn_nama" name="stn_nama" placeholder="Nama Kategori">
		    </div>
		  </div>
		  ...
		  <div class="form-group row">
		    ...
		    <div class="col-sm-9">
		    <textarea  name="stn_ket" class="form-control" id="stn_ket" placeholder="Keterangan"></textarea>
		    </div>
		  </div>
